...
const nestedArray = ["example", 10, ["this","is","nested"], true];
...
const firstNumber = numbers.unshift(5)
console.log(numbers)
// EXERCISE 4
...
const removeApple = fruits.shift("apple")
const addMango =fruits.unshift("mango")
...
const addRat = petsWithPush.push("rat")
...
const removeMango = fruitsWithPop.pop()
...
const shiftApple = shiftedFruits.shift()
